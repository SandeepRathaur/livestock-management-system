...
export default function Milk({ lang }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch("https://livestock-backend-8osq.onrender.com/api/milk", {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    await fetch("https://livestock-backend-8osq.onrender.com/api/milk", {
      method: "POST",
      headers: {
  ...
  const deleteMilk = async (id) => {
    ...
    await fetch(`https://livestock-backend-8osq.onrender.com/api/milk/${id}`, {
      method: "DELETE",
      headers: {
        Authorization: "Bearer " + localStorage.getItem("token")
      }
